# API для Проект Yatube

## Описание

API разработан для [проекта Yatube](https://github.com/vasilekx/hw05_final) на Django REST framework. API позволяет аутентифицированным пользователям управлять своим контентом. Анонимный пользователь есть доступ только на чтение ограниченной информации.
