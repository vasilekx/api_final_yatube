...
API разработан для [учебного проекта Yatube](https://github.com/vasilekx/hw05_final) на DRF. API позволяет аутентифицированным пользователям управлять своим контентом. Анонимный пользователь есть доступ только на чтение ограниченной информации.
